...
public class Mod_ELiSim extends javax.swing.JFrame {
    ...
    public Mod_ELiSim() {
        ...
        jPanel8.add(jLabel2);
        jLabel3.setBounds(155, 40, 290, 30);
        jPanel8.add(jLabel3);
        jLabel4.setVisible(false);
        jLabel5.setVisible(false);
    }
    
    public Mod_ELiSim(int c) {
        initComponents();
        this.setLocationRelativeTo(null);
        sombra_total_panel(jPanel1);
        sombra_total_panel(jPanel3);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("¿Que opcion desea realizar?");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        this.dispose();
        new ModSim(jLabel4.getText(),jLabel5.getText()).setVisible(true);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.dispose();
        ban2 = 1;
        new EliminarSim(jLabel4.getText()).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mod_ELiSim.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
