...
public class EliminarSim extends javax.swing.JFrame {
    ...
    ArrayList<Sim> arraySim = new ArrayList<>();
    int idsim; 
    ...
    public void cargarSim(){
        arraySim = sControl.consultaSim(s, cc);
        
        for(Sim arraySim1: arraySim){
            idsim = arraySim1.getId();
        }
    ...
    public void cargar(){
        ...
        jLabel2.setText("¿Desea Eliminar A Esta Sim Cards?");
        arrayDatos = dControl.unasimcard(d, cc);

        for(Datos arraydatos1: arrayDatos){
            jLabel3.setText(" # De Sim "+String.valueOf(arraydatos1.getCodigo_sim()));
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        boolean ace = sControl.ElimniarSim(idsim);
        
        if(ace){
            aceptar = dControl.eliminardatos(cc);
            boolean aceptar1 = pControl.eliminarPrepago(cc);
            if(aceptar || aceptar1){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarSim.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarSim().setVisible(true);
            }
        });
    }
