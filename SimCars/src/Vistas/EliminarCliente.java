...
public class EliminarCliente extends javax.swing.JFrame {
    ...
    public EliminarCliente(long cc){
        initComponents();
        this.cc = cc;
        this.setLocationRelativeTo(null);
        sombra_total_panel(jPanel2);
    ...
    public void cargar(){
        ...
        jLabel2.setText("¿Desea Eliminar A Esta Persona?");
        String ced = String.valueOf(cc);
        arrayCliente = cContro.ListaUnCliente(c, ced);

        for (Cliente arrayCliente1 : arrayCliente) {
            jLabel3.setText(arrayCliente1.getNombres()+" "+arrayCliente1.getApellidos());
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        System.out.println("ced: "+cc);
        aceptar = cContro.EliminarCliente(String.valueOf(cc));
        if(aceptar){
